...
/**
 * Streams the men's attire reference photo from the Spring backend for the public invitation
...
export async function GET(
  ...
  const backendRes = await fetch(`${API_BASE}/api/public/rsvp/${token}/attire-men-photo`, {
    cache: "no-store",
  });
